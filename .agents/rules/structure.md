...
- Alt projekt kode skal placeres under blackstat package folderen.
- Alle dokumenter omkring koden, og projektet skal placeres i docs folderen, og være skrevet i markdown.
- Data til applikationen skal gemmes i data folderen. Eksempelvis database eller andre data filer. Der må gerne oprettes underfoldere til json, database eller tilsvarende hvis dette er nødvendigt for projektet.
